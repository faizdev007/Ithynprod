...
import { Building, Mail, Phone, ExternalLink, ArrowUpRight, CheckCircle2, Users } from 'lucide-react';
          ...
          <div className="space-y-4" id="footer-newsletter">
            ...
            {subscribed ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full rounded-lg bg-blue-600 hover:bg-blue-500 py-2.5 text-xs font-bold text-white shadow-md transition-all shadow-blue-600/10 cursor-pointer"
                >
                  Join Publication List
                </button>
              </form>
            )}
          </div>
