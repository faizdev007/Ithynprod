...
export default function About({ setCurrentPage, onOpenConsultation }: AboutProps) {
  ...
  const leaders = [
    ...
    },
    {
      ...
      bio: "Manages alliance programs and commercial scoping pipelines. Ed oversees the strategic synergy between ITHYN Advisory and our Engineering Delivery squads.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-24">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base text-slate-600 leading-relaxed">
            Headquartered in London, ITHYN was founded to eliminate the chasm between strategic AI advisory and actual production engineering. We don&apos;t just write reports—we architect and coordinate production systems.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8" id="about-values-grid">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 space-y-4 hover:border-blue-500/20 hover:shadow-md transition-all duration-300">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              ITHYN Solution Architects retain single-point accountability. Even when massive engineering teams are deployed, your primary ITHYN advisor remains your steward from kick-off to delivery.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-10" id="about-timeline">
          ...
          <div className="relative border-l border-slate-200 max-w-3xl mx-auto pl-6 sm:pl-8 space-y-12">
            ...
            <div className="relative">
              ...
              <h4 className="font-display text-sm font-bold text-slate-900 mt-1">Foundation of ITHYN Advisory</h4>
              <p className="text-xs text-slate-600 mt-1 leading-relaxed">
                ITHYN was established in Central London by a team of elite banking data consultants. Our starting mission was clear: eliminate fluff and deliver resilient data architectures that scale.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6 space-y-4">
              ...
              <p className="text-xs text-slate-605 leading-relaxed">
                Clients hire ITHYN for strategic security, architecture design, and governance audits. To execute these blueprints, our integrated engineering delivery teams translate specs directly into production environments.
              </p>
            ...
            <div className="lg:col-span-6 border border-slate-200 bg-slate-50 rounded-2xl p-6 relative font-mono text-xs text-slate-600 shadow-inner" id="about-visual-flow">
              <div className="flex items-center justify-between border-b border-slate-200 pb-3 mb-4">
                <span className="text-2xs uppercase text-slate-550 tracking-wider">ITHYN Framework Integration</span>
              ...
              <div className="space-y-4">
                <div className="rounded-xl border border-slate-200 bg-white p-3.5 space-y-1.5">
                  <div className="flex items-center justify-between text-[11px] font-bold text-slate-900">
                    <span>1. Strategic Advisory (ITHYN)</span>
        ...
        <div className="space-y-10" id="about-leadership">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-xs text-slate-500 leading-relaxed mt-1">
              ITHYN consultants hold decades of engineering and strategic experience across banking, research, and cloud architecture.
            </p>
          </div>
