  ...
  const digitalMarketingDetailed = [
    {
      ...
      icon: <Megaphone className="h-6 w-6 text-blue-600 dark:text-blue-400" />,
      items: [
    ...
    },
    {
      ...
      icon: <AppWindow className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />,
      items: [
    ...
    },
    {
      ...
      icon: <Brain className="h-6 w-6 text-orange-600 dark:text-orange-400" />,
      items: [
    ...
    },
    {
      ...
      icon: <ShoppingBag className="h-6 w-6 text-rose-600 dark:text-rose-400" />,
      items: [
    ...
    },
    {
      ...
      color: 'from-indigo-500/10 to-blue-500/10 dark:from-indigo-500/5 dark:to-indigo-500/5',
    ...
    },
    {
      ...
      icon: <Target className="h-6 w-6 text-pink-600 dark:text-pink-400" />,
      items: [
    ...
    },
    {
      ...
      icon: <Briefcase className="h-6 w-6 text-cyan-600 dark:text-cyan-400" />,
      items: [
      ...
      color: 'from-cyan-500/10 to-sky-500/10 dark:from-cyan-500/5 dark:to-sky-500/5',
    ...
    },
    {
      ...
      color: 'from-yellow-500/10 to-amber-500/10 dark:from-yellow-500/5 dark:to-amber-500/5',
    ...
    },
    {
      ...
      color: 'from-red-500/10 to-rose-500/10 dark:from-red-500/5 dark:to-red-500/5',
      borderColor: 'hover:border-red-500/30'
    }
  ];

  return (
    <div className="relative overflow-hidden py-16 sm:py-20 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100" id="digital-marketing-page">
      {/* Background ambient lighting */}
      <div className="absolute left-[-15%] top-20 h-[500px] w-[500px] rounded-full bg-purple-500/5 dark:bg-purple-500/2 glow-blur pointer-events-none" />
      <div className="absolute right-[-20%] bottom-20 h-[500px] w-[500px] rounded-full bg-pink-500/5 dark:bg-pink-500/2 glow-blur pointer-events-none" />

      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        
        {/* Header Block */}
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-purple-50 dark:bg-purple-950/40 border border-purple-100 dark:border-purple-900 text-purple-600 dark:text-purple-400 text-xs font-bold uppercase tracking-widest">
