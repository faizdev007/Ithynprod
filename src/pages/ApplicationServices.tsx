...
export default function ApplicationServices({ setCurrentPage, onOpenConsultation }: ApplicationServicesProps) {
  const appServicesDetailed = [
    ...
    },
    {
      ...
      icon: <Factory className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />,
      items: [
    ...
    },
    {
      ...
      icon: <Cloud className="h-6 w-6 text-cyan-600 dark:text-cyan-400" />,
      items: [
    ...
    },
    {
      ...
      icon: <Terminal className="h-6 w-6 text-orange-600 dark:text-orange-400" />,
      items: [
    ...
    },
    {
      ...
      icon: <CheckSquare className="h-6 w-6 text-rose-600 dark:text-rose-400" />,
      items: [
    ...
    },
    {
      ...
      icon: <Network className="h-6 w-6 text-teal-600 dark:text-teal-400" />,
      items: [
    ...
    },
    {
      ...
      icon: <Workflow className="h-6 w-6 text-pink-600 dark:text-pink-400" />,
      items: [
  ...
  return (
    <div className="relative overflow-hidden py-16 sm:py-20 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100" id="application-services-page">
      {/* Background ambient lighting */}
      <div className="absolute left-[-15%] top-20 h-[500px] w-[500px] rounded-full bg-blue-500/5 dark:bg-blue-500/2 glow-blur pointer-events-none" />
      <div className="absolute right-[-20%] bottom-20 h-[500px] w-[500px] rounded-full bg-indigo-500/5 dark:bg-indigo-500/2 glow-blur pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        {/* Hero Call-Out */}
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-8 sm:p-12 text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-8">
